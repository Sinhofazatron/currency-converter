...
const { success, currencyCurrent, currencyCurrentList } = variables;

const insertCurrency = (data) => {
  currencyCurrentList.insertAdjacentHTML(
    "afterbegin",
...
const insertCurrencies = () => {
  ...
  currencyCurrent.innerHTML = renderCurrencyItem(currency);
  currencyCurrentList.innerHTML = "";
...
const changeCurrency = () => {
  currencyCurrent.parentElement.classList.add("active");
};
