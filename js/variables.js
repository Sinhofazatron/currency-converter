export default {
  ...
  rateConvrsion: document.querySelector(".rate-conversion"),
  ...
  formSelect: document.getElementById("from"),
  tabs: document.querySelectorAll(".tab"),
  currencyCurrent: document.querySelector(".currency-single__item"),
  currencyCurrentList: document.querySelector(".currency-list"),
